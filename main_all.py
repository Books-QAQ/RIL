...
if __name__ == '__main__':
    ...
    parser.add_argument('--num_freeze_epochs', type=int, default=0)
    ...
    parser.add_argument('--sce_sensitivity', type=float, default=0.8,
                        help='Sensitivity of SCE. Higher value means easier expansion on drift.')

    # ===== Batch-level adapter checkpoint =====
    parser.add_argument('--save_adapter_every', default=0, type=int,
                        help='Save adapter-only checkpoint every N optimizer steps (0 disables).')
    parser.add_argument('--save_adapter_only', action='store_true', default=True,
                        help='If set, only save adapter/head params to reduce size.')
    parser.add_argument('--no_eval', action='store_true',
                        help='Train only: skip evaluation during training')
    parser.add_argument('--max_batches_per_task', type=int, default=0,
                        help='Max train batches per task (0 = no limit)')
    parser.add_argument('--balance_class_domain', action='store_true',
                        help='Use class-domain block balanced sampling in each task')
